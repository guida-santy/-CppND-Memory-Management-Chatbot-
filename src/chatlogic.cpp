            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // https://knowledge.udacity.com/questions/317803
                        // https://www.learncpp.com/cpp-tutorial/lambda-captures/
                        // https://knowledge.udacity.com/questions/574645
                        // &node = unique pointers can't be copied thus they can't be passed as a parameter by value, only by reference
